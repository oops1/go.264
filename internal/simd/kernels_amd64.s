...
// Requires: SSE2
TEXT ·avgBytes16x16(SB), NOSPLIT, $0-96
	MOVQ  dst_base+0(FP), AX
	MOVQ  dstStride+24(FP), CX
	MOVQ  a_base+32(FP), DX
	MOVQ  aStride+56(FP), BX
	MOVQ  b_base+64(FP), SI
	MOVQ  bStride+88(FP), DI
	MOVOU (DX), X0
	MOVOU (SI), X1
	PAVGB X1, X0
	MOVOU X0, (AX)
...
// Requires: SSE2
TEXT ·avgBytes8x16(SB), NOSPLIT, $0-96
	MOVQ  dst_base+0(FP), AX
	MOVQ  dstStride+24(FP), CX
	MOVQ  a_base+32(FP), DX
	MOVQ  aStride+56(FP), BX
...
// Requires: SSE2
TEXT ·avgBytes4x8(SB), NOSPLIT, $0-96
	MOVQ  dst_base+0(FP), AX
	MOVQ  dstStride+24(FP), CX
	MOVQ  a_base+32(FP), DX
	MOVQ  aStride+56(FP), BX
